/**
 * Client-side utility for Follow-Up due dates, badge types, and calculations
 */
...
export function parseDateInput(input) {
  ...
  // Handle strings like "15 Sep 2026", "15 Sep", etc.
...
export function computeDueInfo(dueDate, isCompleted = false) {
  if (isCompleted) {
    return {
      badge: 'Completed',
      badgeType: 'completed',
